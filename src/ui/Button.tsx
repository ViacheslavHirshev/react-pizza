...
function Button({
  ...
  const styles = {
    ...
    small: `inline-block text-xs bg-yellow-400 uppercase font-semibold text-stone-800 
          py-2 px-3 tracking-wide rounded-full hover:bg-yellow-300 transition-colors duration-300
          focus:outline-none focus:ring focus:bg-yellow-300 focus:ring-yellow-300 focus:ring-offset-2
          disabled:cursor-not-allowed sm:px-4 sm:py-2 cursor-pointer md:px-6 md:py-3`,
    ...
    round: base + " px-2.5 py-1 md:px-3.5 md:py-2 text-sm sm:px-3 sm:py-1.5",
  };
